"""
Problem 80 from Top Interview 150: Remove Duplicates From Sorted Array 2
...
class Solution(object):
    def removeDuplicates(self, nums):
        ...
        cur_pointer = 2
        while cur_pointer < n:
            if nums[cur_pointer] == nums[prev_pointer] and nums[cur_pointer] == nums[prev_pointer - 1]:
                cur_pointer += 1
            else:
                prev_pointer += 1
                nums[prev_pointer] = nums[cur_pointer]
                cur_pointer += 1
        nums[0:] = nums[:prev_pointer+1]
